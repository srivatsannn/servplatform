...
import '../merchant_add_service_2.dart';

import 'controllers/image_compresser.dart';
...
class _StoryCreateScreenState extends State<StoryCreateScreen> {
                          ...
                          children: <Widget>[
                            Padding(
                              ...
                              child: GestureDetector(
                                onTap: () {
                                  setState(() {
                                    //navigate to merchant_add_service_2
                                    navigateToMerchantAddService2(context);
                                  });
                                },
                                child: Row(
                                  children: <Widget>[
  ...
  Future navigateToMerchantAddService2(context) async {
    await Navigator.push(context,
        MaterialPageRoute(builder: (context) => MerchantStateEmptyView2()));
  }
