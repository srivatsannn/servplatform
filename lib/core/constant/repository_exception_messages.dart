class RepositoryExceptionMessages {
  static const general_posts = 'Failed to load posts';
  static const general_post = 'Failed to load post';
  static const posts_remote = 'Failed to fetch posts remotely';
  static const post_remote = 'Failed to fetch post remotely';
  static const posts_local = 'Failed to fetch posts locally';
