...
class AgentSetAvailabilityViewModel extends BaseViewModel {
  final _agentSetAvailabilitiesRepository = locator<AgentSetAvailabilitiesRepository>();

  List<AgentSetAvailability> _agentSetAvailabilities = [];
  List<AgentSetAvailability> get agentSetAvailabilities => _agentSetAvailabilities;

  Future<void> init() async {
    setState(ViewState.Busy);
    try {
      final fetchedAgentSetAvailabilities = await _agentSetAbilitiesRepository.fetchAgentSetAvailabilities();
